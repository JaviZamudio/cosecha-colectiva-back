...
export const get_prestamos_nopagados_socio = async (req: AdminRequest<Grupo>, res) => {
    ...
    try {
        ...
        let query = `
            SELECT prestamos.Prestamo_id, prestamos.Monto_prestamo - prestamos.Monto_pagado AS Adeudo_prestamo, prestamos.Interes_generado - prestamos.Interes_pagado AS Adeudo_interes, prestamos.Sesiones_restantes
            FROM prestamos
